...
;
; CALLING SEQUENCE:
;   TRANSREAD_DELIM, UNIT, VARi [, FORMAT=FORMAT]  (first usage)
;      or
;   TRANSREAD_DELIM, UNIT, VARi [, FORMAT=FORMAT], FILENAME=FILENAME  (second usage)
;      or
;   TRANSREAD_DELIM, STRINGARRAY, VARi [, FORMAT=FORMAT]  (second usage)
;
; DESCRIPTION:
;   TRANSREAD_DELIM is based on Markwardt's TRANSREAD. It
;   allows the user to specify a delimiter that separates each data
;   entry. This could be ',' in a csv file. (CDH 7/29/09)
;  
...
pro transread_delim, unit, l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, $
